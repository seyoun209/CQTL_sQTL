...
pbs_sig_qtl_cond_annot$lead_sqtl <- sapply(pbs_sig_qtl_cond_annot$var_id, process_var_id)
fnf_sig_qtl_cond_annot$lead_sqtl <- sapply(fnf_sig_qtl_cond_annot$var_id, process_var_id)
...
4.32e-20  9.88e-01  2.59e-24  5.91e-05  1.20e-02 
