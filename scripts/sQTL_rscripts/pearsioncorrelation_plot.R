...
#Merge with the 
splicingPCA_df <- merge(final_meta_data, pc10_ctl_fnf, by="ID" , all=FALSE)
...
pdf(file = "results_plots/pearsoncorrelation.pdf",   # The directory you want to save the file in
